...
MAIN = main.ml
MLI = expr.mli petri.mli printPetri.mli simul.mli solve.mli tools.mli unionFind.mli printTrans.mli
ML = unionFind.ml tools.ml petri.ml printPetri.ml simul.ml printTrans.ml solve.ml
