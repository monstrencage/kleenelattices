...
module Lst : sig type t = int list val compare : 'a -> 'a -> int end
module Int : sig type t = int val compare : 'a -> 'a -> int end
module LMap :
  sig
    type key = Lst.t
    type 'a t = 'a Map.Make(Lst).t
    val empty : 'a t
...
val add_lst : LMap.key -> 'a -> 'a list LMap.t -> 'a list LMap.t
